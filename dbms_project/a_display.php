...
<table width='400' align='center' border='5' align="center"><tr><td>cust_id:</td><td><?php echo $row1['cust_id']; ?></td></tr>
...
<tr><td>expected delivery date </td><td><?php  $date = strtotime("+7 day");
