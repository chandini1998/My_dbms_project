...
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b><h2>ADMIN&nbsp&nbspLOGIN&nbsp&nbspFORM</h2></b></u></label><br>
...
$query=mysql_query("select * from admin where user_name='$user_name' and password='$password'") or die(mysql_error());
  ...
  $row=  mysql_fetch_array($query);
	...
	header("location: Admin_home.html?id=".$user_name);
   }
   else
   {
