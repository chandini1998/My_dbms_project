...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp CUSTOMER&nbsp&nbspINSERT&nbsp&nbspFORM</h2></b></label>
<div>
...
<input placeholder="Enter customer phone number" type="text" name="cont_num" maxlength="10"  pattern="[789]{1}[0-9]{9}"  /></br>
...
<p>&nbsp &nbsp &nbsp<a href="Admin_home.html" font face="verdana"><b><h3>BACK</h3></b></a></p>
...
echo "<script> alert('Customer is Succussfully inserted')</script>";
